...
pacstrap /mnt base base-devel linux linux-firmware neovim zsh dhcpcd xorg-server xorg xorg-xinit sudo noto-fonts git feh unzip unrar tmux xclip mpd ncmpcpp networkmanager network-manager-applet arch-gtk-theme adobe-source-han-sans-otc-fonts bspwm rofi dunst udiskie xorg-xsetroot xorg-xinput arandr ttf-firacode zsh-autosuggestions zsh-syntax-highlighting
